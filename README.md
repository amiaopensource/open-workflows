...
- [Washington State University Center for Digital Scholarship and Curation (WSU-CDSC)](https://github.com/WSU-CDSC/Documentation): Documentation for digital workflows, with helpful entries on DV transfer and NDSA Levels of Digtial Preservation Surveys.
...
- [Know Your Carrier](http://www.knowyourcarrier.com/): An easy to use website that enables A/V format identification through a progression of prompts and images. It also includes information about preservaton and digitization with a public facing writing style. Created by [VIAA](https://viaa.be/en), it is available in both English and Dutch.
